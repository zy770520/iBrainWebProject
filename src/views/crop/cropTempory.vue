<template>
  ...
  <div class="main">
    ...
    <div v-else class="cut viewer-container">
      ...
      <div v-if="flowItemInfo.type == 'camera'" ref="viewer"
    ...
    <div class="cropIconClass">
      ...
      <el-tooltip effect="dark" content="停止试运行" placement="bottom">
...
export default {
  ...
  methods: {
    init(form, comFlow, flowItemInfo, type) {
      ...
      // 如果已有rect数据，确保prev_rect也被正确初始化
      // if (form && form.rect) {
      //   console.log('初始化裁剪区域数据:', form.rect);
      //   this.prev_rect = form.rect;
      // }
